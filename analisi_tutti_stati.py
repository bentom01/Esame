...
fig.savefig('regione1.png')
plt.show()

df1 = fn.correl(maid, nyd, masd, rid, cond, maim, nym, masm, rim, conm, 'ME', 'NY', 'MA', 'RI', 'CT')
...
fig.suptitle('media della densità di NO2 [$\mu g/m^3$] al giorno [d] in 5 stati confinanti, dati originali e filtrati')
fig.savefig('regione2.png')
plt.show()

df2 = fn.correl(pend, njd, mard, delad, docd, penm, njm, marm, delam, docm, 'PA', 'NJ', 'MD', 'DE', 'DC')
...
fig.suptitle('media della densità di NO2 [$\mu g/m^3$] al giorno [d] in 5 stati confinanti, dati originali e filtrati')
fig.savefig('regione3.png')
plt.show()

df3 = fn.correl(ncd, geod, alad, vird, flod, ncm, geom, alam, virm, flom, 'NC', 'GA', 'AL', 'VA', 'FL')
...
fig.suptitle('media della densità di NO2 [$\mu g/m^3$] al giorno [d] in 5 stati confinanti, dati originali e filtrati')
fig.savefig('regione4.png')
plt.show()

df4 = fn.correl(ohd, indd, kend, illd, misd, ohm, indm, kenm, illm, mism, 'OH', 'IN', 'KY', 'IL', 'MO')
...
fig.suptitle('media della densità di NO2 [$\mu g/m^3$] al giorno [d] in 5 stati confinanti, dati originali e filtrati')
fig.savefig('regione5.png')
plt.show()

df5 = fn.correl(wyod, minnd, iowd, ndd, sdd, wyom, minnm, iowm, ndm, sdm, 'WY', 'MN', 'IA', 'ND', 'SD')
...
fig.suptitle('media della densità di NO2 [$\mu g/m^3$] al giorno [d] in 5 stati confinanti, dati originali e filtrati')
fig.savefig('regione6.png')
plt.show()

df6 = fn.correl(loud, kand, arkd, okd, texd, loum, kanm, arkm, okm, texm, 'LA', 'KS', 'AR', 'OK', 'TX')
...
fig.suptitle('media della densità di NO2 [$\mu g/m^3$] al giorno [d] in 5 stati confinanti, dati originali e filtrati')
fig.savefig('regione7.png')
plt.show()

df7 = fn.correl(cold, nevd, utd, arid, nmd, colm, nevm, utm, arim, nmm, 'CO', 'NV', 'UT', 'AZ', 'NM')
...
fig.suptitle('media della densità di NO2 [$\mu g/m^3$] al giorno [d] in 5 stati confinanti, dati originali e filtrati')
fig.savefig('regione8.png')
plt.show()

df8 = fn.correl(wasd, ored, idad, cald, hawd, wasm, orem, idam, calm, hawm, 'WA', 'OR', 'ID', 'CA', 'HI')
