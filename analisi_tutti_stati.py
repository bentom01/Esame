...
'''
#filtro
alaf = fn.inv(alasp, 20, alatf, alam)
...
idaf = fn.inv(idasp, 1e4, idatf, idam)
...
kenf = fn.inv(kensp, 0, kentf, kenm)
...
misf = fn.inv(missp, 0, mistf, mism)
...
wasf = fn.inv(wassp, 5e2, wastf, wasm)
wyof = fn.inv(wyosp, 1e5, wyotf, wyom)
